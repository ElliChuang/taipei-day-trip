                    ...
                    <div class="login" id="login">\
                        ...
                        <div class="loginBody">\
                            <div class="loginTitle">\
                                <div>登入會員帳號</div>\
                                <button type="submit" id="loginClosed">\
                            ...
                            <div class="form" id="loginForm">\
                                ...
                                <div class="loginPassword">\
                                    ...
                                    <span class="eyeHidden" id="loginPasswordHidden"></span>\
                                    <span class="eyeShow" id="loginPasswordShow"></span>\
                                </div>\
                                <button id="memberLogin">登入帳戶</button>\
                                <div class="loginMessage" id="loginMessage"></div>\
                            </div>\
                            <div class="loginRemind">還沒有帳戶？<span id="goSignUp">點此註冊</span></div>\
                        </div>\
                    </div>\
                    <div class="signup" id="signup">\
                        ...
                        <div class="signupBody">\
                            <div class="signupTitle">\
                                <div>註冊會員帳號</div>\
                                <button type="submit"  id="signUpClosed">\
                                    <img src="/static/image/icon_close.png">\
                                </button>\
                            </div>\
                            <div class="form" id="signUpForm">\
                                ...
                                <div class="loginPassword">\
                                    ...
                                    <span class="eyeHidden" id="signUpPasswordHidden"></span>\
                                    <span class="eyeShow" id="signUpPasswordShow"></span>\
                                </div>\
                                <button id="memberSignUp" > 註冊新帳戶</button>\
                                <div class="signUpMessage" id="signUpMessage"></div>\
                            </div>\
                            <div class="signupRemind">還沒有帳戶了？<span id="goLogin">點此登入</span></div>\
                        </div>\
                    </div>\
                </div>';   
